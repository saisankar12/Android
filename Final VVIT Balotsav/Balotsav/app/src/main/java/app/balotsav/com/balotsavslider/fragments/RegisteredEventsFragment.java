        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setNegativeButton(R.string.no, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getContext(),"పోటీ రద్దు  చేయబడినది ",Toast.LENGTH_LONG).show();
        ...
        databaseReference.child(scode.replace("/","@")).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    if(e.getJ()!=0 || e.getSj()!=0 || e.getS()!=0){
                        switch (e.getName()) {
    ...
    private void generatePDF() {
        try {
            ...
            if (new GrantPermissions(getActivity()).checkAndRequestPermissions()) {
                ...
                List<String> toEmailList = Arrays.asList(schools.getHeadMaster_Email(), "socialsarma@gmail.com");
