        ...
        if(new CheckNetwork(this).isNetworkAvailable()) {
            ...
            builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(EventRegistrationActivity.this, "పోటీ రద్దు  చేయబడినది ", Toast.LENGTH_LONG).show();
                    finish();
    ...
    public void clickRegister(View view) {
        if(new CheckNetwork(this).isNetworkAvailable()) {
            ...
            if (new CheckNetwork(this).isNetworkAvailable()) {
                ...
                databaseReference.setValue(e);
                Toast.makeText(this, R.string.succesfully_reg_for_events, Toast.LENGTH_SHORT).show();
                finish();
            } else
