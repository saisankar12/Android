 ...
 */
public class PanjabiMovies extends Fragment {
    ...
    private final String pajabiurl = "https://api.themoviedb.org/3/discover/movie?api_key=2f8a6ebe46f318b2257843c5fc67f119&with_original_language=pa";
    private URL url;

    public PanjabiMovies() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_panjabi_movies, container, false);
        recyclerView = view.findViewById(R.id.recycler);
        try {
            url = new URL(pajabiurl);
        } catch (MalformedURLException e) {
            e.printStackTrace();
        }

        new PanjabiAsynTask().execute(url);
        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(2, 1));

        return view;
    }

    private void getMovies(String s) throws JSONException {
    ...
    class PanjabiAsynTask extends AsyncTask<URL, Void, String> {
        @Override
