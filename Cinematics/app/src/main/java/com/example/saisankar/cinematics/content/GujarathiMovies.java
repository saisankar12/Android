 ...
 */
public class GujarathiMovies extends Fragment {


    public GujarathiMovies() {
    ...
    private final String gujarathiurl="https://api.themoviedb.org/3/discover/movie?api_key=2f8a6ebe46f318b2257843c5fc67f119&with_original_language=gu";
    private URL url;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view=inflater.inflate(R.layout.fragment_gujarathi_movies, container, false);
        recyclerView=view.findViewById(R.id.recycler);
        try {
            url=new URL(gujarathiurl);
        } catch (MalformedURLException e) {
            e.printStackTrace();
        }

        new GujarathiAsynTask().execute(url);
        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(2,1));
    return view;
    }

    @SuppressLint("StaticFieldLeak")
    class GujarathiAsynTask extends AsyncTask<URL,Void,String> {
        @Override
