 ...
 */
public class TeluguMovies extends Fragment {
    ...
    private final String teluguurl = "https://api.themoviedb.org/3/discover/movie?api_key=2f8a6ebe46f318b2257843c5fc67f119&with_original_language=te";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_telugu_movies, container, false);
        recyclerView = view.findViewById(R.id.recycler);
        try {
            url = new URL(teluguurl);
        } catch (MalformedURLException e) {
            e.printStackTrace();
        }

        new TeluguAsynTask().execute(url);
    ...
    class TeluguAsynTask extends AsyncTask<URL, Void, String> {
        @Override
