 ...
 */
public class EnglishMovies extends Fragment {
    ...
    private final String englishurl = "https://api.themoviedb.org/3/discover/movie?api_key=2f8a6ebe46f318b2257843c5fc67f119&with_original_language=en";
    private URL url;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_english_movies, container, false);
        recyclerView = view.findViewById(R.id.recycler);
        try {
            url = new URL(englishurl);
        } catch (MalformedURLException e) {
            e.printStackTrace();
        }

        new EnglishAsynTask().execute(url);
    ...
    class EnglishAsynTask extends AsyncTask<URL, Void, String> {
        @Override
