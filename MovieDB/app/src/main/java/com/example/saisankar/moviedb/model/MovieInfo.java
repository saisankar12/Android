...
public class MovieInfo implements Parcelable {
    ...
    public MovieInfo(Cursor cursor) {
        ...
        this.mvote_count=0;
        this.mvideo=null;
        this.mvote_average=cursor.getString(1);
        this.mtitle=cursor.getString(2);
        this.mpopularity=null;
        this.mposter_path=cursor.getString(3);
        Log.i("posterpath",cursor.getString(3));
        this.moriginal_language=null;
        this.moriginal_title=cursor.getString(4);
        this.mbackdrop_path=cursor.getString(5);
        this.madult=null;
        this.moverview=cursor.getString(6);
        this.mrelease_date=cursor.getString(7);
