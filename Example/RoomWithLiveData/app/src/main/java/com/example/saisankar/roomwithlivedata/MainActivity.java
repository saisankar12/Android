...
//    static UserDataBase userDataBase;
  static UserViewModel userViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*userDataBase=Room.databaseBuilder(this,UserDataBase.class,"users")
                .allowMainThreadQueries().fallbackToDestructiveMigration().build();
        userList=userDataBase.noteDao().getallUserData();*/
        ...
        userViewModel.getUserLiveData().observe(this, new Observer<List<User>>() {
            ...
            public void onChanged(@Nullable List<User> users) {
                ...
                recyclerView.setAdapter(new NoteAdapter(MainActivity.this,users));
            }
        });
    }
